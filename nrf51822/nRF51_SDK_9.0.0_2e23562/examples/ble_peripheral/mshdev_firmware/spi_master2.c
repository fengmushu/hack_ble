...
uint32_t* spi_master_init2(SPIModuleNumber spi_num, SPIConfig_t *spi_config)
{
    if(spi_num > 1)
    {
        return 0;
...
bool spi_master_tx_rx2(SPIModuleNumber spi_num, uint16_t transfer_size, const uint8_t *tx_data, uint8_t *rx_data)
{
...
/*
bool spi_master_tx_rx2_msh(SPIModuleNumber spi_num, uint16_t transfer_size, const uint8_t *tx_data, uint8_t *rx_data)
{
    if(tx_data == 0 || rx_data == 0)
    {
        return false;
...
bool spi_master_tx2(SPIModuleNumber spi_num, uint16_t transfer_size, const uint8_t *tx_data)
{
...
bool spi_master_rx2(SPIModuleNumber spi_num, uint16_t transfer_size, uint8_t *rx_data)
{
    if(rx_data == 0)
    {
        return false;
