 ...
 *
 */
// modified by Mikhail Sharonov to add tick interrupts to count overfills for RealTimeClock
#include "app_timer.h"
#include <stdlib.h>
#include "nrf51.h"
...
static uint32_t											 m_overload_counts=0; //msh added to count number overloads generated by overflow interrupt
...
{
    if (NRF_RTC1->EVENTS_OVRFLW) m_overload_counts++; //msh
...
uint32_t getOverloadCounts() //msh
{
return m_overload_counts;	
}	

void clearOverloadCounts() //msh
{
m_overload_counts=0;	
}
